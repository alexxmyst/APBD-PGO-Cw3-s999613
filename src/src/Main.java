public class Main {
    ...
    public static void main(String[] args) {
        ...
        ProduktMenu p4 = new ProduktMenu("D-02", "Brownie", 26.0, "deser");

        KlienciKawiarni klient = new KlienciKawiarni(100, "Julia", "Mazur", "j.mazur@mail.pl");
        KlienciKawiarni klient2 = new KlienciKawiarni(200, "Marian", "Nowak", "m.nowak@mail.pl");

        Zamowienie zamowienie = new Zamowienie(klient);
        Zamowienie zamowienie2 = new Zamowienie(klient2);
        ...
        System.out.println(Zamowienie.pobierzKolejnyNumer());
